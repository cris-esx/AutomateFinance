...
using AutomateFinance.Domain.Entities;
...
namespace AutomateFinance.Services
{
    public class NFSeService : INFSeService
    {
        private readonly ILogger<NFSeService> _logger;

        public NFSeService(ILogger<NFSeService> logger)
        {
            _logger = logger;
        }

        public string[] GetAllNFSes(string nfsePDFsPath)
        {
        ...
        public NFSe ExtractNFSeDataFromPdf(Stream pdfStream)
        {
            var nfseData = new NFSe();
            string pdfText = GetTextFromPdfStream(pdfStream);
        ...
        private string GetTextFromPdfStream(Stream pdfStream)
        {
        ...
        public string RenameAndMoveNFSePdf(string filePath, NFSe nfse, string destinationDir)
        {
